...
import { getHospitalImagePath, getCityImagePath } from "@/lib/seo-data/image-helpers";
import {
...
export default async function HospitalPage({
  ...
  // Cascade: hospital image → city image → region image
  const hospitalImage = getHospitalImagePath(nom, city?.slug, city?.region);
    ...
    <section className="py-16 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-dark mb-6">
          Taxi conventionné pour {hospital.name}
        </h1>
